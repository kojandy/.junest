...
complete --command curl --long-option 'etag-save' --description 'Get an ETag from response header and save it to a FILE' 
complete --command curl --long-option 'etag-compare' --description 'Get an ETag from a file and send a conditional request' 
